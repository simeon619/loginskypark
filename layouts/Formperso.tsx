...
export const Formperso = ({ navigation }: { navigation?: any }) => {
  ...
  const randomImages = {
    locataire: require('../assets/images/confident.png'),
    proprio: require('../assets/images/surprised.png'),
    resident: require('../assets/images/shocked.png'),
    org: require('../assets/images/joker.png'),
    Gestion: require('../assets/images/surprised.png'),
  };
    ...
    <>
      ...
      >
        <View style={styles.form}>
          <SelectMultiple name="statut" control={control}  />
          <Input
            name="name"
            control={control}
